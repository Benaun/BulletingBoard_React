        ...
        <form onSubmit={handleSubmit(addPostHandler)}>
          ...
          <div className='pt-5 grid grid-cols-2 gap-[30px] items-center'>
            ...
            <div className='flex gap-[20px] flex-col items-center col-span-2'>
              ...
              />
              <Button
                className='inline-flex items-center justify-center rounded-md px-4 py-2.5 text-sm font-medium transition-colors text-white focus:outline-none focus:ring-2 bg-blue-600 hover:bg-blue-700'
                type='submit'
              >
